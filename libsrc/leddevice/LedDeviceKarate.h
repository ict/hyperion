...
///
class LedDeviceKarate : public LedRs232Device
{
public:
	///
	...
	///
	LedDeviceKarate(const std::string& outputDevice, const unsigned baudrate);
...
private:
	...
	/// Helper function to insert the CRC value into a buffer
	void finalizeBuffer(std::vector<uint8_t> &buffer);
};
